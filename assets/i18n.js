const i18n = {
  ...
  translations: {
    ...
    // SHARED SECTION TITLES (all cases)
    'sec1-title': { en: '1. Executive Summary', pt: '1. Resumo Executivo' },
    'sec2-title': { en: '2. Business Challenge', pt: '2. Desafio de Negócio' },
    'sec3-title': { en: '3. Diagnostic Approach', pt: '3. Abordagem de Diagnóstico' },
    ...
    'sec6-title': { en: '6. Transformation Roadmap', pt: '6. Roadmap de Transformação' },
    'sec7-title': { en: '7. Governance Model', pt: '7. Modelo de Governança' },
    'sec8-title': { en: '8. KPI Framework', pt: '8. Framework de KPIs' },
    'sec9-title': { en: '9. Risks and Mitigations', pt: '9. Riscos e Mitigações' },
    'sec10-title': { en: '10. Business Impacts and Results', pt: '10. Impactos e Resultados de Negócio' },
    'sec11-title': { en: '11. Executive Takeaway', pt: '11. Conclusão Executiva' },

    // CASE 01 CONTENT
    'c01-m1-label': { en: '12% → 2%', pt: '12% → 2%' },
    'c01-m1-desc': { en: 'Stockout reduction', pt: 'Redução de ruptura de estoque' },
    'c01-m2-label': { en: '≈ BRL 8M', pt: '≈ BRL 8M' },
    'c01-m2-desc': { en: 'Identified value opportunity', pt: 'Oportunidade de valor identificada' },
    'c01-s1-p1': { en: 'A leading manufacturer identified significant revenue leakage caused by chronic product unavailability. Stockouts reached 12% of SKUs, leading to lost sales, customer dissatisfaction, and emergency logistics costs.', pt: 'Uma fabricante líder identificou um vazamento significativo de receita causado pela indisponibilidade crônica de produtos. A ruptura de estoque atingiu 12% dos SKUs, resultando em perda de vendas, insatisfação de clientes e custos logísticos emergenciais.' },
    ...
    'c01-s2-p1': { en: 'The organization must address the immediate availability gap while protecting service levels, customer commitments, operational efficiency, and financial discipline.', pt: 'A organização precisa tratar a lacuna imediata de disponibilidade enquanto protege os níveis de serviço, compromissos com clientes, eficiência operacional e disciplina financeira.' },
    'c01-s2-h3-1': { en: 'Current-State Signals', pt: 'Sinais do Estado Atual' },
    'c01-s2-li1': { en: 'Stockout rate of 12% across core product families', pt: 'Taxa de ruptura de 12% nas famílias de produtos principais' },
    'c01-s2-li2': { en: 'Excess inventory in slow-moving categories', pt: 'Excesso de estoque em categorias de baixo giro' },
    'c01-s2-li3': { en: 'Fragmented demand forecasting across channels', pt: 'Previsão de demanda fragmentada entre canais' },
    'c01-s2-li4': { en: 'Low confidence in inventory data accuracy', pt: 'Baixa confiança na precisão dos dados de estoque' },
    'c01-s2-li5': { en: 'Unclear ownership of availability targets', pt: 'Responsabilidade pouco clara pelas metas de disponibilidade' },
    'c01-s3-p1': { en: 'The assessment would combine:', pt: 'A avaliação combinaria:' },
    'c01-s3-li1': { en: 'End-to-end supply chain mapping', pt: 'Mapeamento da cadeia de suprimentos ponta a ponta' },
    'c01-s3-li2': { en: 'Demand forecast accuracy review', pt: 'Revisão da precisão da previsão de demanda' },
    'c01-s3-li3': { en: 'Inventory segmentation and policy audit', pt: 'Segmentação de estoque e auditoria de políticas' },
    'c01-s3-li4': { en: 'Root-cause analysis of stockout events', pt: 'Análise de causa raiz de eventos de ruptura' },
    'c01-s3-li5': { en: 'Capability and governance assessment', pt: 'Avaliação de capacidade e governança' },
    'c01-s3-li6': { en: 'Financial value-leakage analysis', pt: 'Análise financeira de vazamento de valor' },
    'c01-s3-li7': { en: 'Risk and change-readiness evaluation', pt: 'Avaliação de risco e prontidão para mudança' },
    'c01-s4-li1': { en: 'A significant share of stockouts is caused by planning-system weaknesses rather than supply disruptions.', pt: 'Uma parcela significativa das rupturas é causada por fragilidades no sistema de planejamento, não por interrupções no suprimento.' },
    'c01-s4-li2': { en: 'The organization lacks one reliable view of demand, inventory, and availability.', pt: 'A organização não possui uma visão única e confiável de demanda, estoque e disponibilidade.' },
    'c01-s4-li3': { en: 'Local inventory optimization will not sustain without governance, capability building, and integrated planning routines.', pt: 'A otimização local de estoques não se sustentará sem governança, desenvolvimento de capacidade e rotinas integradas de planejamento.' },
    'c01-s4-li4': { en: 'The transformation should be sequenced to stabilize availability, optimize inventory, and then scale.', pt: 'A transformação deve ser sequenciada para estabilizar a disponibilidade, otimizar o estoque e depois escalar.' },
    'c01-s5-li1': { en: 'Segment inventory using ABC-XYZ classification', pt: 'Segmentar estoque usando classificação ABC-XYZ' },
    'c01-s5-li2': { en: 'Redesign forecasting and demand review process', pt: 'Redesenhar o processo de previsão e revisão de demanda' },
    'c01-s5-li3': { en: 'Implement inventory policy optimization', pt: 'Implementar otimização da política de estoques' },
    'c01-s5-li4': { en: 'Launch daily availability monitoring', pt: 'Lançar monitoramento diário de disponibilidade' },
    'c01-s5-li5': { en: 'Build planner capability in structured problem solving', pt: 'Desenvolver capacidade de planejadores em solução estruturada de problemas' },
    'c01-s6-h3-1': { en: 'Phase 1 — Diagnose and Stabilize | 0–30 Days', pt: 'Fase 1 — Diagnosticar e Estabilizar | 0–30 Dias' },
    'c01-s6-h3-2': { en: 'Phase 2 — Redesign and Pilot | 31–90 Days', pt: 'Fase 2 — Redesenhar e Pilotar | 31–90 Dias' },
    'c01-s6-h3-3': { en: 'Phase 3 — Scale and Embed | 3–12 Months', pt: 'Fase 3 — Escalar e Incorporar | 3–12 Meses' },
    'c01-s6-li1': { en: 'Confirm baseline, scope, and value at stake', pt: 'Confirmar linha de base, escopo e valor em jogo' },
    'c01-s6-li2': { en: 'Establish governance and decision rights', pt: 'Estabelecer governança e direitos de decisão' },
    'c01-s6-li3': { en: 'Contain critical availability risks', pt: 'Conter riscos críticos de disponibilidade' },
    'c01-s6-li4': { en: 'Select priority product families', pt: 'Selecionar famílias de produtos prioritárias' },
    'c01-s6-li5': { en: 'Align leaders around a single transformation narrative', pt: 'Alinhar líderes em torno de uma única narrativa de transformação' },
    'c01-s6-li6': { en: 'Redesign planning processes and inventory policies', pt: 'Redesenhar processos de planejamento e políticas de estoque' },
    'c01-s6-li7': { en: 'Pilot future-state solutions on priority SKUs', pt: 'Pilotar soluções de estado futuro em SKUs prioritários' },
    'c01-s6-li8': { en: 'Build dashboards and availability-monitoring standards', pt: 'Construir dashboards e padrões de monitoramento de disponibilidade' },
    'c01-s6-li9': { en: 'Train planners and demand reviewers', pt: 'Treinar planejadores e revisores de demanda' },
    'c01-s6-li10': { en: 'Validate operational and financial impact', pt: 'Validar impacto operacional e financeiro' },
    'c01-s6-li11': { en: 'Scale proven practices across all categories', pt: 'Escalar práticas comprovadas para todas as categorias' },
    'c01-s6-li12': { en: 'Integrate standards into daily management', pt: 'Integrar padrões à gestão diária' },
    'c01-s6-li13': { en: 'Link inventory performance to value realization', pt: 'Vincular performance de estoque à realização de valor' },
    'c01-s6-li14': { en: 'Develop internal planning capability', pt: 'Desenvolver capacidade interna de planejamento' },
    'c01-s6-li15': { en: 'Audit sustainability and adjust the operating model', pt: 'Auditar sustentabilidade e ajustar o modelo operacional' },
    'c01-s7-th1': { en: 'Forum', pt: 'Fórum' },
    'c01-s7-th2': { en: 'Cadence', pt: 'Cadência' },
    'c01-s7-th3': { en: 'Purpose', pt: 'Propósito' },
    'c01-s7-td1-1': { en: 'Executive Steering Committee', pt: 'Comitê Diretivo Executivo' },
    'c01-s7-td1-2': { en: 'Monthly', pt: 'Mensal' },
    'c01-s7-td1-3': { en: 'Strategic decisions, value and risk', pt: 'Decisões estratégicas, valor e risco' },
    'c01-s7-td2-1': { en: 'Transformation Review', pt: 'Revisão da Transformação' },
    'c01-s7-td2-2': { en: 'Biweekly', pt: 'Quinzenal' },
    'c01-s7-td2-3': { en: 'Milestones, dependencies and escalation', pt: 'Marcos, dependências e escalação' },
    'c01-s7-td3-1': { en: 'Workstream Review', pt: 'Revisão de Workstream' },
    'c01-s7-td3-2': { en: 'Weekly', pt: 'Semanal' },
    'c01-s7-td3-3': { en: 'Delivery, actions and barriers', pt: 'Entrega, ações e barreiras' },
    'c01-s7-td4-1': { en: 'Daily Management', pt: 'Gestão Diária' },
    'c01-s7-td4-2': { en: 'Daily', pt: 'Diário' },
    'c01-s7-td4-3': { en: 'Availability monitoring and rapid response', pt: 'Monitoramento de disponibilidade e resposta rápida' },
    'c01-s7-h3-1': { en: 'Core Roles', pt: 'Funções Principais' },
    'c01-s7-li1': { en: 'Executive Sponsor: owns ambition and removes enterprise barriers', pt: 'Patrocinador Executivo: assume a ambição e remove barreiras empresariais' },
    'c01-s7-li2': { en: 'Transformation Lead: integrates workstreams and value delivery', pt: 'Líder de Transformação: integra workstreams e entrega de valor' },
    'c01-s7-li3': { en: 'Planning Process Owner: owns future-state availability performance', pt: 'Dono do Processo de Planejamento: assume a performance de disponibilidade do estado futuro' },
    'c01-s7-li4': { en: 'Workstream Lead: delivers milestones and manages risks', pt: 'Líder de Workstream: entrega marcos e gerencia riscos' },
    'c01-s7-li5': { en: 'Finance Partner: validates benefits', pt: 'Parceiro Financeiro: valida benefícios' },
    'c01-s7-li6': { en: 'Change Lead: manages adoption, communication, and capability', pt: 'Líder de Mudança: gerencia adoção, comunicação e capacidade' },
    'c01-s8-li1': { en: 'Stockout rate below 2% in 180 days', pt: 'Taxa de ruptura abaixo de 2% em 180 dias' },
    'c01-s8-li2': { en: 'Forecast accuracy above 80%', pt: 'Precisão da previsão acima de 80%' },
    'c01-s8-li3': { en: 'Inventory turnover improvement of 25%', pt: 'Melhoria de 25% no giro de estoque' },
    'c01-s8-li4': { en: 'Service level above 98%', pt: 'Nível de serviço acima de 98%' },
    'c01-s8-li5': { en: 'Weekly verified financial impact', pt: 'Impacto financeiro verificado semanalmente' },
    'c01-s8-p1': { en: 'KPIs should include clear definitions, owners, data sources, targets, thresholds, and required actions when performance moves outside tolerance.', pt: 'Os KPIs devem incluir definições claras, responsáveis, fontes de dados, metas, limites e ações necessárias quando a performance sair da tolerância.' },
    'c01-s9-th1': { en: 'Risk', pt: 'Risco' },
    'c01-s9-th2': { en: 'Mitigation', pt: 'Mitigação' },
    'c01-s9-td1-1': { en: 'Transformation fatigue', pt: 'Fadiga de transformação' },
    'c01-s9-td1-2': { en: 'Limit priorities and visibly stop low-value work', pt: 'Limitar prioridades e interromper visivelmente trabalhos de baixo valor' },
    'c01-s9-td2-1': { en: 'Weak leadership alignment', pt: 'Alinhamento fraco da liderança' },
    'c01-s9-td2-2': { en: 'Use explicit decision rights and sponsor routines', pt: 'Usar direitos de decisão explícitos e rotinas de patrocínio' },
    'c01-s9-td3-1': { en: 'Poor data quality', pt: 'Qualidade de dados deficiente' },
    'c01-s9-td3-2': { en: 'Establish baseline validation and metric governance', pt: 'Estabelecer validação de linha de base e governança de métricas' },
    'c01-s9-td4-1': { en: 'Benefits not sustained', pt: 'Benefícios não sustentados' },
    'c01-s9-td4-2': { en: 'Assign process owners and audit post-implementation results', pt: 'Atribuir donos de processo e auditar resultados pós-implantação' },
    'c01-s9-td5-1': { en: 'Employee resistance', pt: 'Resistência de funcionários' },
    'c01-s9-td5-2': { en: 'Involve users in design and provide role-based support', pt: 'Envolver usuários no design e fornecer suporte baseado em funções' },
    'c01-s9-td6-1': { en: 'Operational disruption', pt: 'Interrupção operacional' },
    'c01-s9-td6-2': { en: 'Pilot changes and use readiness gates before scaling', pt: 'Pilotar mudanças e usar gates de prontidão antes de escalar' },
    'c01-s10-p1': { en: 'The transformation is expected to improve availability, inventory efficiency, customer service levels, planning capability, and financial performance. Final benefits would be validated jointly by operations and finance.', pt: 'Espera-se que a transformação melhore a disponibilidade, a eficiência de estoque, os níveis de serviço ao cliente, a capacidade de planejamento e o desempenho financeiro. Os benefícios finais seriam validados em conjunto pelas operações e finanças.' },
    'c01-s11-p1': { en: 'Sustainable availability is not managed through firefighting. It is a disciplined system connecting demand sensing, inventory policy, planning capability, governance, and value realization.', pt: 'A disponibilidade sustentável não é gerenciada através de apagar incêndios. É um sistema disciplinado que conecta percepção de demanda, política de estoques, capacidade de planejamento, governança e realização de valor.' },
    'c01-back-portfolio': { en: 'Back to the main portfolio', pt: 'Voltar ao portfólio principal' },
