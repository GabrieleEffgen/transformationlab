# Optimizing Inventory Through Process Transformation
...
Inventory has increased while service levels remain unstable. Teams compensate for uncertainty through excess stock rather than solving planning and flow problems.
...
- Poor parameter governance
- Forecast and demand signals disconnected
- High schedule instability
- Obsolete inventory hidden
- Service measured only at aggregate level
...
- Segment inventory by value and variability
- Review policies and planning parameters
- Improve schedule stability
- Create exception-based inventory governance
- Link stock decisions to service and cash
