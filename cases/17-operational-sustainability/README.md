# Operational Sustainability Through Process Excellence

**Capability:** ESG and Operations  
...
The company has sustainability targets but operational teams struggle to translate them into process-level actions and financial value.
...
- Targets disconnected from daily work
- Environmental data delayed
- Improvement projects ignore resource efficiency
- No ownership by value stream
...
- Map energy, water, waste, and emissions by process
- Integrate sustainability into loss analysis
- Prioritize projects by environmental and financial value
- Set process-level targets
- Create governance and verification
...
- Avoided cost
- Emissions reduction
- Sustainability project payback
