# Plant Expansion Using Lean Principles

**Capability:** Manufacturing Strategy  
...
A company plans to expand capacity but risks replicating existing inefficiencies, excessive movement, and poor flow in the new layout.
...
- Capacity assumptions not validated
- Layout designed by departments
- Material flow secondary
- Future product mix uncertain
- Automation decisions made too early
...
- Validate demand and capacity scenarios
- Design around value streams and flow
- Use simulation and spaghetti analysis
- Build flexibility into layout
- Stage automation based on stable processes
...
- Lower investment per unit of capacity
- Reduced travel distance
- Higher future-state productivity
- Faster ramp-up
