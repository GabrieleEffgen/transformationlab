# Recovering Operational Performance After a Major Crisis

**Capability:** Business Resilience  
...
A major disruption has affected output, service, morale, and financial performance. Leaders need to restore control while preparing the organization for a more resilient future.
...
- Unclear crisis priorities
- Conflicting information
- Short-term fixes create new risks
- Workforce fatigue
- Recovery and resilience treated separately
...
- Create a recovery control tower
- Protect critical customer and safety priorities
- Establish one verified data source
- Separate containment, recovery, and redesign
- Capture lessons into resilience standards
...
- Backlog reduction
- Employee workload stabilization
- Critical risk closure
- Resilience actions completed
